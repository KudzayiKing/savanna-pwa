...
export default function PaymentsPage() {
  ...
  if (!isAuthenticated) return <SavannaShell><section className="grid min-h-[60vh] place-items-center rounded-[30px] border border-[#dce1d3] bg-white p-8 text-center"><div><CircleDollarSign className="mx-auto size-8 text-[#80522a]" /><h1 className="mt-4 font-display text-3xl font-semibold">Your payment requests, in one place.</h1><Button onClick={() => startLogin()} className="mt-5 rounded-xl bg-[#24482f] text-white">Sign in to payments</Button></div></section></SavannaShell>;
