...
/**
 * History icon - used for recent emojis and frequently used stickers. The arc
 * redraws, then the clock hand settles into place.
 */
const HistoryIcon = forwardRef<ChatIconHandle, ChatIconProps>(
  (
    {
      onMouseEnter,
      onMouseLeave,
